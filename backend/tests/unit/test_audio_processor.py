...
def test_dsp_gain(processor):
    processor.update_settings(gain=6.0, filter_enabled=False, cutoff_freq=1000, integration_time=0)
...
def test_panning_left(processor):
    ...
    processor.update_settings(gain=0.0, filter_enabled=False, cutoff_freq=1000, integration_time=0)
...
def test_update_filter_params(processor):
    # Enable filter
    processor.update_settings(filter_enabled=True, cutoff_freq=2000, integration_time=0.1)
